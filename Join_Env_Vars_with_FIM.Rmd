...
Match the nitrogen observation with catch observation based on year, month, and closest Lat and Long.

Must have same year, same month, and closest Lat observation then append on nitrogen observation. 
