...
#gbm plotting where Y variable is plotted in response form, not link function style 

"plot.gbm.liz" <- function (x, i.var = 1, n.trees = x$n.trees, continuous.resolution = 500, 
                            return.grid = FALSE, type = "response", ...) 
{
